...
<petclinic:layout pageName="games">
	<body style="background: url(/resources/images/backgroundPetris.jpg)">
		...
		<p align=center>PASA ESTE CÓDIGO A TU AMIGO Y COMIENZA A JUGAR CON
			ÉL</p>
		<br>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<p>
					...
					<button class="btn btn-default" style="margin-left: 31%"
						onclick="window.location.href='/games/saveFriend/${game.token}' ">
