...
<body style="background: url(/resources/images/backgroundPetris.jpg)">
	<petclinic:layout pageName="tools">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<spring:url value="/resources/images/PetrisLogo.png"
					htmlEscape="true" var="PetrisLogo" />
		...
		<br></br>
		<div class="row">
			<h2 align="center">Bienvenido a las herramientas de
				Administrador de Petris</h2>
		</div>
		<br>
		<div class="row" align="center">
			<button class="btn btn-default" id="pedrito2"
				...
				<span>Registro de modificaci�n</span>
			</button>
		...
		<br>
			<button class="btn btn-default" id="pedrito2"
				...
				<span>Listado de partidas en curso</span>
			</button>
